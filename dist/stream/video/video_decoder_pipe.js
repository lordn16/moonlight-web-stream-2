        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.config) {
                if (setup.codec == "H264" || setup.codec == "H264_HIGH8_444") {
                    this.translator = new H264StreamVideoTranslator((_f = this.logger) !== null && _f !== void 0 ? _f : undefined);
                    ...
                    this.translator = new H265StreamVideoTranslator((_g = this.logger) !== null && _g !== void 0 ? _g : undefined);
                    const codec = VIDEO_DECODER_CODECS_OUT_OF_BAND[setup.codec];
                    yield this.trySetConfig(codec);
                }
                else if (setup.codec == "AV1_MAIN8" || setup.codec == "AV1_MAIN10" || setup.codec == "AV1_HIGH8_444" || setup.codec == "AV1_HIGH10_444") {
                    this.errored = true;
                    (_a = this.logger) === null || _a === void 0 ? void 0 : _a.debug("Av1 stream translator is not implemented currently!", { type: "fatalDescription" });
                    return;
                }
                else {
                    this.errored = true;
                    (_b = this.logger) === null || _b === void 0 ? void 0 : _b.debug(`Failed to find stream translator for codec ${setup.codec}`);
                    return;
                }
            }
            if (!this.config) {
                this.errored = true;
                (_c = this.logger) === null || _c === void 0 ? void 0 : _c.debug(`Failed to setup VideoDecoder for codec ${setup.codec} because of missing config`);
                return;
            }
            (_d = this.translator) === null || _d === void 0 ? void 0 : _d.setBaseConfig(this.config);
            (_e = this.logger) === null || _e === void 0 ? void 0 : _e.debug(`VideoDecoder config: ${JSON.stringify(this.config)}`);
            this.reset();
